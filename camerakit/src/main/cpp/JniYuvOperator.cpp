...
Java_com_jameshong_camerakit_YuvOperator_jniStoreYuvData(JNIEnv *env, jobject obj,
                                                          jbyteArray yuv420sp, jint width,
                                                          jint height);
JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniRotateYuvCcw90(JNIEnv *env, jobject obj,
                                                            jobject handle);
JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniRotateYuvCw90(JNIEnv *env, jobject obj,
                                                           jobject handle);
JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniRotateYuv180(JNIEnv *env, jobject obj,
                                                          jobject handle);
JNIEXPORT jobject JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniGetYuvData(JNIEnv *env,
                                                        jobject obj,
                                                        jobject handle);
JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniFreeYuvData(JNIEnv *env, jobject obj,
                                                         jobject handle);
}
...
JNIEXPORT jobject JNICALL
Java_com_jameshong_camerakit_YuvOperator_jniGetYuvData(JNIEnv *env, jobject obj,
                                                        jobject handle) {
    JniYuvOperator *yuvOperator = (JniYuvOperator *) env->GetDirectBufferAddress(handle);
