...
Java_com_jameshong_camerakit_JpegTransformer_jniStoreJpeg
        (JNIEnv *env, jobject obj, jbyteArray jpeg, jint jpegSize);

JNIEXPORT jbyteArray JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniCommit
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniReleaseJpeg
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT jint JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniGetWidth
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT jint JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniGetHeight
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniRotate
        (JNIEnv *env, jobject obj, jobject handle, jint degrees);

JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniFlipHorizontal
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniFlipVertical
        (JNIEnv *env, jobject obj, jobject handle);

JNIEXPORT void JNICALL
Java_com_jameshong_camerakit_JpegTransformer_jniCrop
