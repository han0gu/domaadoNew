...
import static com.jameshong.camerakit.CameraKit.Constants.FOCUS_CONTINUOUS;
import static com.jameshong.camerakit.CameraKit.Constants.FOCUS_OFF;
import static com.jameshong.camerakit.CameraKit.Constants.FOCUS_TAP;
import static com.jameshong.camerakit.CameraKit.Constants.METHOD_STANDARD;
import static com.jameshong.camerakit.CameraKit.Constants.METHOD_STILL;
...
public class Camera1 extends CameraImpl {
    ...
    @Override
    void setTimerShutter(int timerShutter) {
        this.mTimerShutter = timerShutter;
    }

    @Override
    int getTimerShutter() {
        return this.mTimerShutter;
    }

    @Override
    void setTimerCountdown(int timerCountdown) {
        this.mTimerCountdown = timerCountdown;
    }

    @Override
    int getTimerCountdown() {
        return this.mTimerCountdown;
    }
