...
abstract class CameraImpl {
    ...
    abstract void setTimerShutter(int timerShutter);
    abstract int getTimerShutter();

    abstract void setTimerCountdown(int timerCountdown);
    abstract int getTimerCountdown();
