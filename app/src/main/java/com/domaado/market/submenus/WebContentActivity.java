package com.domaado.market.submenus;
...
import com.domaado.market.sensors.GPSTrackerListener;
import com.domaado.market.share.KakaoTalklink;
import com.domaado.market.webview.HandleUiListener;
import com.domaado.market.webview.JavaScriptInterface;
import com.domaado.market.webview.MyWebChromeClient;
import com.domaado.market.webview.MyWebInterface;
import com.domaado.market.webview.MyWebView;
import com.domaado.market.webview.MyWebViewClient;
import com.domaado.market.widget.KeyboardHeightProvider;
import com.domaado.market.widget.SoftKeyboardStateWatcher;
...
public class WebContentActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public final static String ACTION_FILTER = "com.domaado.market.firebase.action";
    public final static String ACTION_UPDATE_LOCATION = "com.domaado.market.update.location";
...
//    }
    ...
    private void setUI() {
        ...
        if(TextUtils.isEmpty(path)) {
            path = getResources().getString(R.string.url_site) + getResources().getString(R.string.url_webcontent_main, Common.getDefaultUUID(this, UUID.randomUUID().toString()));
        }
