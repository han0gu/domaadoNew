...
import com.domaado.market.BuildConfig;
...
public class ImagePicker {
    ...
    public static Intent getPickImageIntentNexus5(Context context) {
        Intent chooserIntent = null;
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
        myLog.d(TAG, "*** getImageFromResult, resultCode: " + resultCode);
        Bitmap bm = null;
        File imageFile = getTempFile(context);
        if (resultCode == Activity.RESULT_OK) {

            myLog.d(TAG, "*** imageFile : "+imageFile.exists()+", "+imageFile.getAbsolutePath());
...
//                    imageReturnedIntent.getData().toString().contains(imageFile.toString()));
            ...
            myLog.d(TAG, "*** selectedImage: " + selectedImage.getPath());
    ...
    private static Bitmap decodeBitmap(Context context, Uri theUri, int sampleSize) {
        ...
        myLog.d(TAG, "*** "+options.inSampleSize + " sample method bitmap ... " +
    ...
    private static Bitmap getImageResized(Context context, Uri selectedImage) {
        ...
        do {
            ...
            myLog.d(TAG, "*** resizer: new bitmap width = " + bm.getWidth());
            i++;
    ...
    private static int getRotation(Context context, Uri imageUri, boolean isCamera) {
        ...
        myLog.d(TAG, "*** Image rotation: " + rotation);
        return rotation;
    }
