...
import com.domaado.market.widget.AutoFitTextureView;
...
@SuppressLint("NewApi")
public class Camera2BasicFragment extends AppCompatActivity implements View.OnClickListener {
	...
	*/
	...
	//private AutoFitTextureView cameraFrame;
	...
	*/
	private CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
		...
		public void onCaptureProgressed(@NonNull CameraCaptureSession session,
		    ...
		    if(partialResult!=null) process(partialResult);
		}
	...
	*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_get_new);
	...
	private void setUI() {
    	...
    	((Button) findViewById(R.id.camera_get_shot_btn)).setOnClickListener(this);
    	((Button) findViewById(R.id.camera_get_base_btn)).setOnClickListener(this);
    	((Button) findViewById(R.id.camera_get_cancel_btn)).setOnClickListener(this);
    	findViewById(R.id.camera_submit_btn).setOnClickListener(this);

		//cameraFrame = (AutoFitTextureView)findViewById(R.id.texture);
		//dotbox = (ImageView)findViewById(R.id.camera_get_area);
...
//		view.findViewById(R.id.camera_shot_btn).setOnClickListener(this);
//		view.findViewById(R.id.camera_cancel_btn).setOnClickListener(this);
//
//		cameraFrame = (AutoFitTextureView)view.findViewById(R.id.texture);
//		dotbox = (ImageView)view.findViewById(R.id.camera_get_area);
//
//		//view.findViewById(R.id.info).setOnClickListener(this);
...
//
//		try {
//			if(TextUtils.isEmpty(btnstring)) btnstring = mContext.getResources().getString(R.string.btn_yes);
//
//			myDialog.setMessage(message);
//
//			if(handler != null) {
//				myDialog.setPositiveButton(mContext.getResources().getString(R.string.btn_cancel), new View.OnClickListener() {
//					@Override
...
//				});
//
//				myDialog.setNegativeButton(btnstring, new View.OnClickListener() {
//
//					@Override
//					public void onClick(View v) {
//						// TODO Auto-generated method stub
...
//
//						//if(isFinish) myFinish();
//					}
//				});
//			} else {
//				myDialog.setPositiveButton(mContext.getResources().getString(R.string.btn_ok), new View.OnClickListener() {
//					@Override
//					public void onClick(View v) {
//						// TODO Auto-generated method stub
//						myDialog.dismiss();
...
//	}
	...
	private void runBaseCamera() {
    	...
    	Camera2BasicFragment.this.finish();
	}
	...
	private String getDotBoxInfo() {
    	...
    	myLog.d(TAG, "getDotBoxInfo: view w:"+ mTextureView.getMeasuredWidth()+", h:"+mTextureView.getMeasuredHeight());
    	...
    	int x = mTextureView.getMeasuredWidth(); //(textureView.getMeasuredWidth() - dotbox.getMeasuredWidth()) / 2;
		int y = mTextureView.getMeasuredHeight(); //(textureView.getMeasuredHeight() - dotbox.getMeasuredHeight()) / 2;
	...
	private void updateButtonCount() {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				camera_get_shot_btn.setText(getResources().getString(R.string.btn_shot_count, String.valueOf(fnameSeq+1), String.valueOf(MAX_SHOT)));
			}
		});
	}
}
