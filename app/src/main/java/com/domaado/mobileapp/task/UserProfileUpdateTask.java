 ...
 */
public class UserProfileUpdateTask extends AsyncTask<String, String, UserProfileUpdateResponse> {

    private String TAG = UserProfileUpdateTask.class.getSimpleName();
    ...
    public UserProfileUpdateTask(Activity act, UserProfileUpdateRequest request, boolean showProgress, Handler handler) {
        this.mActivity = act;
    ...
    @Override
    protected UserProfileUpdateResponse doInBackground(String... param) {
        UserProfileUpdateResponse result = null;
    ...
    @Override
    protected void onPostExecute(UserProfileUpdateResponse result) {
     ...
     * @return
     */
    private UserProfileUpdateResponse getResponseData(String jsonString) {
