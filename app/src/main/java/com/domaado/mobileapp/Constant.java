...
public class Constant {
    ...
    public static final String WEBVIEW_USER_AGENT   = "mobileapp androidapp";
    ...
    public final static String REFRESH_FILTER = "com.domaado.mobileapp.firebase.refresh.list";
    public final static String OPENURL_FILTER = "com.domaado.mobileapp.firebase.open.url";
