...
public class CustomZoomableImageView extends AppCompatImageView {
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        int borderWidth = (int) (borderPaint!= null ? borderPaint.getStrokeWidth() : 0);
    ...
    private class ScaleListener extends
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            myLog.d(LOG_TAG, "*** mScaleFactor " + mScaleFactor);
            myLog.d(LOG_TAG, "*** pivotPointY " + pivotPointY + ", pivotPointX= "
                    + pivotPointX);
